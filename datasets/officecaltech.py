...
from datasets.utils.federated_dataset import FederatedDataset, partition_office_domain_skew_loaders_new, partition_home_domain_skew_loaders_new
...
class FedLeaOfficeCaltech(FederatedDataset):
    ...
    percent_dict = { 'caltech': 0.1,'amazon': 0.1,'webcam':0.1, 'dslr': 0.1}
