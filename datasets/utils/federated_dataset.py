...
def partition_office_domain_skew_loaders_new(train_datasets: list, test_datasets: list,
    ...
    return setting.train_loaders, setting.test_loader
def partition_home_domain_skew_loaders_new(train_datasets: list, test_datasets: list,
                                             setting: FederatedDataset) -> Tuple[list, list]:
    ini_len_dict = {}
    not_used_index_dict = {}
    all_labels_list = []
...
def partition_home_domain_skew_loaders(train_datasets: list, test_datasets: list,
                                         setting: FederatedDataset) -> Tuple[list, list]:
    ini_len_dict = {}
    not_used_index_dict = {}
    # all_labels = []
