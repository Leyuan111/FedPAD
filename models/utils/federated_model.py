...
class FederatedModel(nn.Module):
    ...
    def loc_update(self, priloader_list,iter):
        pass
    ...
    def aggregate_nets(self, freq):
        ...
        # pre_global_net = self.pre_global_net
        nets_list = self.nets_list
        # freq1=None
        online_clients = self.online_clients
        global_w = self.global_net.state_dict()
        # pre_global_w = self.pre_global_net.state_dict()
        # if freq== None:
        # if freq.any() == None:
        if freq == None:
        ...
        for index,net_id in enumerate(online_clients):
            ...
            if first:
                first = False
                for key in net_para:
                    # pre_global_w[key] = net_para[key] * freq1[index]
        ...
        # pre_global_net.load_state_dict(pre_global_w)
